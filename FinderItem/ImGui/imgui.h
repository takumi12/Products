...
namespace ImGui
{
    ...
    IMGUI_API bool          InputInt64(const char* label, unsigned long* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputShort(const char* label, short* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);

    IMGUI_API bool          InputNumber(const char* label, int i, void* p_data, const char* format, ImGuiDataType data_type, ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          TreeNodeOpen(const char* label);
    ...
    IMGUI_API bool          SelectableHovered(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0)); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
