...
#include "GRefCount.h"
// Include Loader because GFxLog derives from GFxStateBag.
#include "GFxLoader.h"
...
// *** Inline implementation for GFxStateBag (GFxLoader.h) - must come after GFxLog.

inline  void    GFxStateBag::SetLog(GFxLog *plog)
{
    SetState(GFxState::State_Log, plog);
}
inline  GPtr<GFxLog> GFxStateBag::GetLog() const
{
