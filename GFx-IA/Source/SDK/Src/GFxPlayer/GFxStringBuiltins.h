...
enum GASBuiltinType
{
    ...
    GASBuiltin_StyleSheet,
    GASBuiltin_NetConnection,
    GASBuiltin_NetStream,
    GASBuiltin_Video,
    GASBuiltin_BitmapFilter,
    GASBuiltin_DropShadowFilter,
    GASBuiltin_GlowFilter,
    GASBuiltin_BlurFilter,
    GASBuiltin_BevelFilter,
    GASBuiltin_ColorMatrixFilter,
    GASBuiltin_TextSnapshot,
    GASBuiltin_SharedObject,
    GASBuiltin_LocManager,
    ...
    GASBuiltin_onPressAux,             // Event_PressAux
    GASBuiltin_onReleaseAux,           // Event_ReleaseAux
    GASBuiltin_onReleaseOutsideAux,    // Event_ReleaseOutsideAux
    GASBuiltin_onDragOverAux,          // Event_DragOverAux
    GASBuiltin_onDragOutAux,           // Event_DragOutAux
    ...
    GASBuiltin_rendererString,
    GASBuiltin_rendererFloat,
    GASBuiltin_rendererMatrix,

    GASBuiltin_focusGroupMask,
    // AMP
    GASBuiltin_Amp,
...
public:
    ...
    GASStringBuiltinManager(GASStringManager* strMgr);
    ~GASStringBuiltinManager();

    GMemoryHeap*    GetHeap() const { return StringManager->GetHeap(); }
    ...
    GASString        CreateString(const char *pstr, UPInt length)        { return StringManager->CreateString(pstr, length); }
    GASString        CreateString(const GString& str)                  { return StringManager->CreateString(str); }
...
public:
    ...
    inline GMemoryHeap* GetHeap() const;
    ...
    GASString    CreateString(const char *pstr, UPInt length) const;    
    GASString    CreateString(const GString& str) const;
    ...
    class GFxMovieRoot* GetMovieRoot();
