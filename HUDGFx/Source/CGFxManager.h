...
BoostSmart_Ptr(CNewUIObj);
typedef std::map<int, CNewUIObjPtr > type_map_uibase;
typedef std::vector<CNewUIObjPtr> type_vector_uibase;
...
public:
	...
	void AddObj(DWORD index, CNewUIObjPtr pUIObj);
	void RemoveUIObj(DWORD index);
	void RemoveAllUIObjs();
	void ReleaseAllUIObj();

	CNewUIObjPtr FindUIObj(DWORD key);
	...
	static bool AddObjWrapper(void*& obj, DWORD index, CInternalmethod* pcommand, CExternalmethod* method, const char* FileName, int aligntype);
	static void CreateDevice(void*& obj, DWORD iWindowWidth, DWORD iWindowHeight);
	static bool UpdateWrapper(void*& obj);
	static bool RenderWrapper(void*& obj);
	static bool RenderWithKeyWrapper(void*& obj, DWORD dwKey);
	static bool UpdateWithKeyWrapper(void*& obj, DWORD dwKey);
	static bool UpdateMouseEventWrapper(void*& obj, DWORD dwKey, int Event);
	static void HideAllWrapper(void*& obj);
	static void ShowWrapper(void*& obj, DWORD dwKey);
	static void HideWrapper(void*& obj, DWORD dwKey);
	static void ToggleWrapper(void*& obj, DWORD dwKey);
	static bool IsVisibleWrapper(void*& obj, DWORD dwKey);
	static bool InvokeWrapper(void*& obj, DWORD index, const char* pmethodName, const char* pargFmt, va_list args);
	static bool InvokeArgWrapper(void*& obj, DWORD index, const char* pmethodName, CEICommandContainer& args);
	static bool InvokeArrayWrapper(void*& obj, DWORD index, const char* pmethodName, CEICommandContainer* args, int Size);

	static void CallBackWrapper(void*& obj, HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
#define GMScaleForm			(CGFxManager::Instance())