...
// Define this macro to enable the use of sockets for TCP/IP communication
// This is normally used by AMP and is left defined even in shipping builds for AMP client
//#define GFX_USE_SOCKETS
...
/*#if !defined(GFC_BUILD_SHIPPING) && !defined(GFC_NO_THREADSUPPORT)
