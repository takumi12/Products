...
public:
    ...
    virtual bool    HandleFontRequest(const GFxAmpMessageFontRequest*)      { return false; }
    virtual bool    HandleFontData(const GFxAmpMessageFontData*)            { return false; }
...
public:
    ...
    virtual void OnMsgGFxVersionChanged(GFxAmpMessage::GFxVersionType newVersion) = 0;
