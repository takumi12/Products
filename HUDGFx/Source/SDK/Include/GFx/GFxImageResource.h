...
public:
    ...
    inline bool        IsExternal() const { return pImageInfo ? pImageInfo->IsExternal() : false;  }
    inline GImageBase::ImageFormat GetImageFormat() const { return pImageInfo ? pImageInfo->GetFormat() : GImageBase::Image_None; }
#endif
