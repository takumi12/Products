...
public:
    ...
    virtual bool WriteJpeg(GFile* pout, int quality, GImage* image) = 0;
...
public:
    ...
    // Write image to the stream.
    virtual bool WriteJpeg(GFile* pout, int quality, GImage* image);
...
// to force library linking only when used.
    ...
    bool GetMovieInfo(const char* pfilename, GFxMovieInfo *pinfo, bool getTagCount = 0, UInt loadConstants = LoadAll);
