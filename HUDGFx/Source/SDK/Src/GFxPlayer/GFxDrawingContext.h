...
class GFxDrawingContext : public GRefCountBaseNTS<GFxDrawingContext, GFxStatMV_MovieClip_Mem>
{
public:
...
protected:
    GPtr<GFxShapeWithStyles>   Shapes;
...
public:
    ...
    bool IsSolidFill(UInt rgba) const;
