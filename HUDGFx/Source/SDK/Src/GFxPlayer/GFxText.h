...
{    
    ...
    GStringLH               DefaultText;
    GStringLH               VariableName;
...
// Helper struct.
class GFxStaticTextRecord : public GNewOverrideBase<GFxStatMD_CharDefs_Mem>
{
public:
    class GlyphEntry
    {
...
public:
    ...
    GArrayLH<GFxStaticTextRecord*, GFxStatMD_CharDefs_Mem> Records;
...
public:
    ...
    // Support for complex objects API
    virtual void SetNeedToUpdateGeomData() = 0;
    virtual GPointF TransformToTextRectSpace(const GFxValue::DisplayInfo& pinfo) const = 0;
    virtual void GetPosition(GFxValue::DisplayInfo* pinfo) = 0;
    virtual GASString GetText(GASEnvironment* penv, bool reqHtml) const = 0;
    virtual void SetText(const char* pnewText, bool reqHtml) = 0;
    virtual void SetText(const wchar_t* pnewText, bool reqHtml) = 0;
    ...
    virtual GFxFontResource* GetFontResource() = 0;
...
class GASTextFieldObject : public GASObject
{
    ...
    friend class GASTextFieldCtorFunction;
...
protected:
    void Finalize_GC()
    {
        pTextField.~GWeakPtr<GFxASCharacter>();
...
protected:
    ...
    GASTextFieldObject(GASStringContext *psc, GASObject* pprototype);
    GASTextFieldObject(GASEnvironment* penv);
public:
...
{
public:
    GASTextFieldCtorFunction(GASStringContext *);
    ...
    static void GetFontList(const GASFnCall& fn);
};
