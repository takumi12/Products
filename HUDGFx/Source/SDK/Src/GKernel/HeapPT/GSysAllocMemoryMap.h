...
#ifndef INC_GSysAllocMemoryMap_H
#define INC_GSysAllocMemoryMap_H

#include "GSysAlloc.h"

// ***** GSysAllocMemoryMap
//
// GSysAllocMemoryMap provides a system allocator implementation for 
// systems that allow to reserve address space and then map and unmap
// arbitrary memory pages. O
//
// This version differs from GSysAllocWinAPI and GSysAllocMMAP in such a way 
...
// of providing their own GSysAllocPaged implementation. Since GSysAllocMemoryMap relies on
...
// efficiency, GSysAllocMemoryMap does not lose any memory on 4K alignment required
// internally by GMemoryHeap. No alignment overhead means that GSysAllocMemoryMap uses
...
//------------------------------------------------------------------------
class GSysAllocMemoryMap : public GSysAllocPaged
{
    struct Segment
    {
        UByte*  Memory;
...
public:
    ...
    GSysAllocMemoryMap(GSysMemoryMap* mapper, UPInt segSize, 
