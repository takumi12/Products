...
bool GMEmpireGuardian4::MoveMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 164:
	{
		...
		{
			CreateEffecttime(MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffecttime(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffecttime(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
		...
		{
			CreateEffecttime(MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffecttime(MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffecttime(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
	...
	case MODEL_MONSTER01 + 165:
	{
		...
		case MONSTER01_ATTACK2:
		{
			...
			{
				CreateEffecttime(BITMAP_GATHERING, o->Position, o->Angle, o->Light, 1, o);
			}
			...
			if (8.0f <= o->AnimationFrame && o->AnimationFrame < 10.1f)
			{
				...
				for (int i = 0; i < 100; i++)
				{
					...
					CreateParticletime(BITMAP_FIRE, vPosition, o->Angle, o->Light, 0);
...
{
	if (gMapManager.IsEmpireGuardian4() == false)// || time_base_check == false)
		return false;
	...
	case 20:
	{
		if (o->AnimationFrame > 5.4f && o->AnimationFrame < 6.5f)
		{
			...
			for (int i = 0; i < 4; ++i)
			{
				...
				CreateJointtime(BITMAP_JOINT_SPARK, o->Position, o->Position, Angle, 5, o);
			}
			CreateParticletime(BITMAP_SPARK, o->Position, Angle, o->Light, 11);
		}
	...
	case 50:
	{
		...
		for (int i = 2; i <= 7; i++)
		{
			...
			CreateParticletime(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLight1, 4, o->Scale * 0.6f);
			CreateParticletime(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLight2, 4, o->Scale * 0.3f);
		}
	}
	return true;
	...
	case 64:
	{
			...
			(o->AnimationFrame > 23.5f && o->AnimationFrame < 25.5f))
		{
			...
			VectorAddTime(o->Position, vPosition, Position);

			Vector(0.04f, 0.03f, 0.02f, Light);
			for (int i = 0; i < 3; ++i)
			{
				CreateParticletime(BITMAP_CLOUD, Position, o->Angle, Light, 22, o->Scale, o);
			}
		}
	}
	return true;
	case 79:
	{
		...
		{
		case 0:
			CreateParticletime(BITMAP_FIRE_HIK1, o->Position, o->Angle, vLight, 0, o->Scale);
			break;
		case 1:
			CreateParticletime(BITMAP_FIRE_CURSEDLICH, o->Position, o->Angle, vLight, 4, o->Scale);
			break;
		case 2:
			CreateParticletime(BITMAP_FIRE_HIK3, o->Position, o->Angle, vLight, 0, o->Scale);
			break;
		}
	}
	return true;
	...
	case 82:
	{
		CreateParticletime(BITMAP_WATERFALL_5, o->Position, o->Angle, Light, 9, o->Scale);
	}
	return true;
	case 83:
	{
		Vector(1.f, 1.f, 1.f, Light);
		CreateParticletime(BITMAP_WATERFALL_3, o->Position, o->Angle, Light, 14, o->Scale);
	}
	return true;
	case 84:
	{
		...
		if (rand() % 8 == 0)
		{
			CreateParticletime(BITMAP_WATERFALL_2, o->Position, o->Angle, Light, 4, o->Scale);
		}
	}
	return true;
	case 85:
	...
	case 86:
	{
		if (rand() % 6 == 0)
		{
			...
			CreateParticletime(BITMAP_CLOUD, o->Position, o->Angle, Light, 21, o->Scale, o);
		}
	}
	return true;
	...
	case 131:
	{
		...
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, Light, 22, o->Scale);

			Vector(1.f, 1.f, 1.f, Light);
			CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, Light, 21, o->Scale * 2.0f, o);
		}
	}
	return true;
	...
	case 132:
	{
		...
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, Light, 60, o->Scale, o);
	...
	case 157:
	{
...

		{
			for (int i = 0; i < 3; ++i)
			{
				...
				for (int j = 0; j < 5; ++j)
				{
					CreateParticletime(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLightFire01, 3, o->Scale * 0.2f);
					CreateParticletime(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLightFire02, 3, o->Scale * 0.1f);
				}
...

		{
			for (int i = 0; i < 3; i++)
			{
				...
				for (int j = 0; j < 4; ++j)
				{
					CreateParticletime(BITMAP_SMOKE, vPos, o->Angle, vLightSmoke, 65, o->Scale * 0.1, o);
				}
			}
		}
	}
	...
	case 158:
	{
		...
		{
			CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, Light, 64, o->Scale, o);
		}
	}
	return true;
	}
...
bool GMEmpireGuardian4::RenderMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 164:
	{
		...
		CreateParticletime(BITMAP_SPARK + 1, vPos, o->Angle, vLight, 10, 2.0f);
		...
		if (g_isNotCharacterBuff(o) == true && g_isCharacterBuff(o, eBuff_Berserker) == true)
		{
			...
			for (int i = 0; i < iBoneCount; ++i)
			{
				...
				if (i % 5 == 0)
				{
					...
					CreateParticletime(BITMAP_SMOKE, vPosRage, o->Angle, vLightRage, 50, 1.0f);
					CreateParticletime(BITMAP_SMOKELINE1 + rand() % 3, vPosRage, o->Angle, vLightRage, 0, 1.0f);
				}
			}
		}
	}
