	...
	case MODEL_MONSTER01 + 115:
	{
			...
			(o->AnimationFrame >= 5.5f && o->AnimationFrame <= 6.5f))
		{
			...
			if (gMapManager.WorldActive == WD_39KANTURU_3RD)
			{
				...
				for (int i = 0; i < 2; i++)
					CreateParticletime(BITMAP_SMOKE, to->Position, to->Angle, vLight, 1);

				Vector(0.4f, 1.0f, 0.6f, vLight);
				CreateParticletime(BITMAP_TWINTAIL_WATER, to->Position, to->Angle, vLight, 0);
			}
			else
			{
				Vector(0.4f, 0.9f, 0.6f, vLight);
...
bool M38Kanturu2nd::Render_Kanturu2nd_ObjectVisual(OBJECT* o, BMD* b)
{
	...
	case 8:
	{
		...
		CreateParticletime(BITMAP_ENERGY, Position, o->Angle, Light, 0, 1.5f);
		...
		if (rand() % 20 == 0)
		{
			CreateJointtime(BITMAP_JOINT_THUNDER, StartPos, EndPos, o->Angle, 18, NULL, 40.f);
		}
	}
	break;
	case 10:
	{
		if (rand() % 6 == 0)
		{
			...
			CreateParticletime(BITMAP_WATERFALL_3, vPos, o->Angle, Light, 7, o->Scale);
		}
	}
	break;
	case 45:
	...
	case 50:
	{
		if (rand() % 3 == 0)
		{
			...
			CreateParticletime(BITMAP_CLOUD, o->Position, o->Angle, Light, 11, o->Scale, o);
		}
	}
	break;
	case 51:
	...
	case 52:
	{
		...
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticletime(BITMAP_WATERFALL_3, o->Position, o->Angle, Light, 7, o->Scale);
		}
	}
	break;
	case 53:
	{
		if (rand() % 3 == 0)
		{
			...
			CreateParticletime(BITMAP_TWINTAIL_WATER, o->Position, o->Angle, Light, 1);
		}
	}
	break;
	case 54:
	{
		if (rand() % 20 == 0)
		{
			CreateJointtime(BITMAP_JOINT_THUNDER + 1, o->Position, o->Position, o->Angle, 8, NULL, 30.f + rand() % 10);
		}
	}
	break;
	case 55:
	{
		if (rand() % 5 == 0)
		{
			...
			CreateEffecttime(MODEL_FENRIR_THUNDER, o->Position, o->Angle, Light, 1, o);
		}
	...
	case 56:
	{
		if (rand() % 10 == 0)
		{
			CreateJointtime(BITMAP_JOINT_THUNDER + 1, o->Position, o->Position, o->Angle, 9, NULL, 30.f + rand() % 10);
		}
	}
	break;
	case 65:
	{
		if (rand() % 10 == 0)
		{
			CreateJointtime(BITMAP_JOINT_THUNDER + 1, o->Position, o->Position, o->Angle, 10, NULL, 30.f + rand() % 10);
		}
	}
	break;
	}
...
bool M38Kanturu2nd::Render_Kanturu2nd_MonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 114:
	{
		...
		if (rand() % 5 == 0)
		{
			CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, vLight, 40);
		}
		...
		if (rand() % 3 == 0)
		{
			...
			CreateParticletime(BITMAP_WATERFALL_3, vPos, o->Angle, vLight, 5, 0.8f, o);
		...
		if (o->CurrentAction == MONSTER01_ATTACK1 && (o->AnimationFrame >= 3.f && o->AnimationFrame <= 4.f))
		{
			...
			CreateEffecttime(MODEL_STORM, o->Position, o->Angle, vLight, 0);
		}
		else if (o->CurrentAction == MONSTER01_ATTACK2 && (o->AnimationFrame >= 3.f && o->AnimationFrame <= 4.f))
		{
			...
			for (int j = 0; j < 2; j++)
			{
				...
				CreateJointtime(BITMAP_JOINT_SPIRIT, vPos, o->Position, vAngle, 0, o, 80.f);
				CreateJointtime(BITMAP_JOINT_SPIRIT, vPos, o->Position, vAngle, 0, o, 20.f);
			}
		}
		else if (o->CurrentAction == MONSTER01_DIE)
		{
			...
			Vector(0.5f, 0.5f, 0.5f, vLight);
			BoneManager::GetBonePosition(o, "PRSona_Tail", vPos);
			CreateParticletime(BITMAP_WATERFALL_3, vPos, o->Angle, vLight, 6, 0.8f, o);
			BoneManager::GetBonePosition(o, "PRSona_Tail1", vPos);
			CreateParticletime(BITMAP_WATERFALL_3, vPos, o->Angle, vLight, 6, 0.8f, o);
	...
	case MODEL_MONSTER01 + 115:
	{
		...
		if (o->CurrentAction == MONSTER01_WALK)
		{
			...
			if (dwTime > 500)
			{
				if (o->m_iAnimation % 2 == 1)
				{
					...
					CreateEffecttime(MODEL_TWINTAIL_EFFECT, vPos, o->Angle, vLight, 0, o);
				}
		...
		else if (o->CurrentAction == MONSTER01_DIE)
		{
			...
			if (o->AnimationFrame <= 3.0f)
			{
				...
				for (int i = 0; i < 5; i++)
				{
					CreateParticletime(BITMAP_SMOKE, o->Position, o->Angle, vLight, 39);
				}
				Vector(0.4f, 1.0f, 0.6f, vLight);
				CreateParticletime(BITMAP_TWINTAIL_WATER, o->Position, o->Angle, vLight, 0);

				CreateEffecttime(MODEL_SKILL_INFERNO, o->Position, o->Angle, o->Light, 9, o);

				if (o->AnimationFrame <= 0.2f)
				{
					Vector(0.4f, 1.0f, 0.6f, vLight);
					CreateEffecttime(MODEL_TWINTAIL_EFFECT, o->Position, o->Angle, vLight, 1, o);
					CreateEffecttime(MODEL_TWINTAIL_EFFECT, o->Position, o->Angle, vLight, 2, o);
				}
			}
		}
		return true;
	...
	case MODEL_MONSTER01 + 116:
	{
		...
		if (o->CurrentAction != MONSTER01_STOP1 && o->CurrentAction != MONSTER01_DIE && gMapManager.WorldActive != WD_39KANTURU_3RD)
		{
			if (rand() % 3 == 0)
			{
				...
				CreateParticletime(BITMAP_CLUD64, vPos, o->Angle, vLight, 0);
		...
		else if (o->CurrentAction == MONSTER01_DIE)
		{
			...
			CreateParticletime(BITMAP_SMOKE + 3, vPos, o->Angle, vLight, 3, 1.0f);
		...
		if (o->CurrentAction == KANTURU2ND_NPC_ANI_ROT)
		{
			...
			if (iAnimationFrame < 40)
			{
				if (rand() % 4 == 0)
				{
					...
					CreateParticletime(BITMAP_SPARK + 1, vPos, o->Angle, vLight, 18, 1.0f);
			...
			if (rand() % 4 == 0)
			{
				...
				CreateParticletime(BITMAP_CLUD64, vPos, o->Angle, vLight, 2, 2.f);
			...
			if (iAnimationFrame >= 12 && iAnimationFrame <= 25)
			{
				...
				CreateJointtime(BITMAP_JOINT_ENERGY, vPos, vPos2, o->Angle, 42, o, 10.f);
				CreateJointtime(BITMAP_JOINT_ENERGY, vPos, vPos2, o->Angle, 42, o, 10.f);
			}
	...
	case MODEL_MONSTER01 + 115:
	{
		...
		else if (o->CurrentAction == MONSTER01_ATTACK2)
		{
			...
			if (gMapManager.WorldActive == WD_39KANTURU_3RD)
			{
				...
				{
					BoneManager::GetBonePosition(o, "Twintail_Hair24", vRelative, vPos);
					CreateJointtime(BITMAP_JOINT_ENERGY, vPos, to->Position, o->Angle, 0, to, 30.f);
				}
