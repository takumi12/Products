...
public:
	...
	GLuint LoadImageUnZip(const std::string& filename, unsigned char* Data, long DataBytes, GLuint uiFilter = GL_NEAREST, GLuint uiWrapMode = GL_CLAMP_TO_EDGE);
	bool LoadImageUnZip(GLuint uiBitmapIndex, const std::string& filename, unsigned char* Data, long DataBytes, GLuint uiFilter = GL_NEAREST, GLuint uiWrapMode = GL_CLAMP_TO_EDGE);
...
protected:
	...
	bool OpenJpeg(GLuint uiBitmapIndex, const std::string& filename, unsigned char* Data, long DataBytes, GLuint uiFilter = GL_NEAREST, GLuint uiWrapMode = GL_CLAMP_TO_EDGE);
	bool OpenTga(GLuint uiBitmapIndex, const std::string& filename, unsigned char* Data, long DataBytes, GLuint uiFilter = GL_NEAREST, GLuint uiWrapMode = GL_CLAMP_TO_EDGE);
