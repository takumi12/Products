...
bool SEASON3B::CNewUIButton::Render(bool RendOption)
{
	...
	if (m_Name.size() != 0)
	{
		...
		int y = m_Pos.y + ((m_Size.y - Fontsize.cy) / 2);
...
bool SEASON3B::CNewUIButton::Render(float uw, float uv)
{
	SEASON3B::RenderImageF(m_CurImgIndex, m_Pos.x, m_Pos.y, m_Size.x, m_Size.y, m_CurImgColor, 0.f, m_CurImgState * uv, uw, uv);
