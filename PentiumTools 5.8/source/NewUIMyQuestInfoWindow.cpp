...
void SEASON3B::CNewUIMyQuestInfoWindow::SetPos(int x, int y)
{
	...
	{
		m_CurQuestListBox.SetPosition(m_Pos.x + 18, m_Pos.y + 160);
		m_QuestContentsListBox.SetPosition(m_Pos.x + 18, m_Pos.y + 390);


		m_BtnExit.SetPos(m_Pos.x + 20, m_Pos.y + 395);
		m_btnQuestOpen.SetPos(m_Pos.x + 48, m_Pos.y + 395);
		m_btnQuestGiveUp.SetPos(m_Pos.x + 76, m_Pos.y + 395);
	}
	else
	{
		...
		m_btnQuestOpen.SetPos(m_Pos.x + 50, m_Pos.y + 392);
		m_btnQuestGiveUp.SetPos(m_Pos.x + 87, m_Pos.y + 392);
	}
}
