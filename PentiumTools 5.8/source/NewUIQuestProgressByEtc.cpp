...
void CNewUIQuestProgressByEtc::RenderBackImage()
{
	if (gmProtect->LookAndFeel == 1 || gmProtect->LookAndFeel == 2)
	{
		RenderInventoryInterface(m_Pos.x, m_Pos.y, 186.0);
	}
	else
	{
...
void CNewUIQuestProgressByEtc::SetCurNPCWords()
{
	...
	//if (gmProtect->LookAndFeel == 1 || gmProtect->LookAndFeel == 2)
	//{
	//	nLine = ::DivideStringByPixel(&m_aszNPCWords[0][0], QPE_NPC_LINE_MAX, QPE_WORDS_ROW_MAX, g_QuestMng.GetNPCWords(m_dwCurQuestIndex), 150);
	//}
	//else
	//{
