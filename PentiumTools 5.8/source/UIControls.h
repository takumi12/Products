...
public:
	...
	virtual void RenderText(int iPos_x, int iPos_y, const char* pszText, int iBoxWidth = 0, int iBoxHeight = 0, int iSort = RT3_SORT_LEFT, OUT SIZE* lpTextSize = NULL) = 0;
...
public:
	...
	void RenderText(int iPos_x, int iPos_y, const unicode::t_char* pszText, int iBoxWidth = 0, int iBoxHeight = 0, int iSort = RT3_SORT_LEFT, OUT SIZE* lpTextSize = NULL);
...
public:
	...
	void RenderText(int iPos_x, int iPos_y, const char* pszText, int iBoxWidth = 0, int iBoxHeight = 0, int iSort = RT3_SORT_LEFT, OUT SIZE* lpTextSize = NULL);
