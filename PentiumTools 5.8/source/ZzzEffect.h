...
//------------------------------------------------
int CreateParticle(int Type, vec3_t Position, vec3_t Angle, vec3_t Light, int SubType = 0, float Scale = 1.f, OBJECT* Owner = NULL, bool fotograp = false);
int CreateParticletime(int Type, vec3_t Position, vec3_t Angle, vec3_t Light, int SubType = 0, float Scale = 1.f, OBJECT* Owner = NULL, bool fotograp = false);
...
void CreateEffecttime(int Type,vec3_t Position,vec3_t Angle,vec3_t Light,int SubType=0,OBJECT *Target=NULL,short PKKey=-1, WORD SkillIndex=0,WORD Skill=0,WORD SkillSerialNum=0, float Scale = 0.0f, short int sTargetIndex = -1);
void MoveEffects();
//------------------------------------------------
