...
int CreateParticletime(int Type, vec3_t Position, vec3_t Angle, vec3_t Light, int SubType, float Scale, OBJECT* Owner, bool fotograp)
{
	if (time_base_check)
		return CreateParticle(Type, Position, Angle, Light, SubType, Scale, Owner, fotograp);
	return false;
}

int CreateParticle(int Type, vec3_t Position, vec3_t Angle, vec3_t Light, int SubType, float Scale, OBJECT* Owner, bool fotograp)
{
		...
		if (o->Live)
		{
			...
			case BITMAP_FIRE_HIK2_MONO:
				...
				else if (o->SubType == 5)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 2 + 5) * 0.01f);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 7)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac(((rand() % 3 + 3) * 0.01f));
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 8)
				{
					...
					VectorAddTime(o->Position, vMoveVec, o->Position);
			...
			case BITMAP_FIRE + 1:
				...
				else if (o->SubType == 0)
				{
					...
					o->Position[2] += o->Gravity * timefac(20.f);
			...
			case BITMAP_SMOKE:
				...
				case 46:
				{
					...
					o->Scale += timefac(o->Scale / timepow(100.0f));
				}
				break;
				case 47:
				{
			...
			case BITMAP_FIRE_HIK1_MONO:
				...
				else if (o->SubType == 1)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 2 + 4) * 0.01f);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 2)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 3 + 7) * 0.01f);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 3)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 3 + 2) * 0.01f);
					}
					else
					{
						o->Live = false;
			...
			case BITMAP_FIRE_HIK3_MONO:
				...
				else if (o->SubType == 1)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 2 + 6) * 0.01f);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 4)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= timefac((rand() % 4 + 5) * 0.01f);
					}
					else
					{
						o->Live = false;
			...
			case BITMAP_BLOOD + 1:
				...
				VectorAddTime(o->Position, o->Velocity, o->Position);
				break;
			case BITMAP_SPARK:
				Luminosity = (float)o->LifeTime / 16.f;
			...
			case BITMAP_SPARK + 1:
				...
				case 2:
					...
					o->Scale += timefac(0.05f);
					VectorAddTime(o->StartPosition, o->Velocity, o->Position);
					VectorCopy(o->Position, o->StartPosition);
					break;
				case 3:
					o->Scale *= timepow(0.8f);
			...
			case BITMAP_TRUE_BLUE:
				...
				if (o->SubType >= 3 && o->SubType < 5 && o->Target != NULL)
				{
					...
					if (BoneManager::GetBonePosition(o->Target, name, TargetPosition)) {
						...
						o->Scale -= (length * timepow(0.003f));
						o->Light[0] -= (length * timepow(0.08f));
						o->Light[1] -= (length * timepow(0.08f));
						o->Light[2] -= (length * timepow(0.08f));
					}
				}
			...
			case BITMAP_WATERFALL_2:
				...
				o->Scale += (timefac(0.03f));
				o->Velocity[0] = (rand() % 20 - 10) * timepow(0.1f);
				o->Velocity[1] = (rand() % 20 - 10) * timepow(0.1f);
				o->Velocity[2] += (timefac(0.1f));
				if (o->LifeTime < 10)
				{
					o->Light[0] /= (timepow(1.1f));
			...
			case BITMAP_CURSEDTEMPLE_EFFECT_MASKER:
			{
				...
				if (o->SubType == 0)
				{
					...
					if (rand() % 2 == 1)
						CreateParticletime(BITMAP_CURSEDTEMPLE_EFFECT_MASKER, o->StartPosition, o->Angle, Light, 1, 1.3f);
				}
			}
			break;
			case BITMAP_RAKLION_CLOUDS:
			{
				...
				if (rand() % 10 == 0)
				{
					...
					fRand1 = (float)((rand() % 2000) - 1000) * timepow(0.001f);
					fRand2 = (float)((rand() % 2000) - 1000) * timepow(0.001f);
					fRand3 = (float)((rand() % 2000) - 1000) * timepow(0.001f);
