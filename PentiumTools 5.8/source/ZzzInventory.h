...
void RenderItem3D(float sx, float sy, float Width, float Height, int Type, int Level, int Option1, int ExtOption, bool PickUp = false, float Scale = 0.0);
...
namespace SEASON3B
{
	...
	extern void SetButtonImagen(CNewUIButton* button, int imgindex1, int imgindex2);
