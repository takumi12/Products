...
#define INVENTORY_MAIN_SIZE		(COLUMN_INVENTORY*ROW_INVENTORY)

#define INVENTORY_EXT1_SIZE		(INVENTORY_MAIN_SIZE + COLUMN_INVENTORY_EXT * ROW_INVENTORY_EXT)
#define INVENTORY_EXT2_SIZE		(INVENTORY_EXT1_SIZE + COLUMN_INVENTORY_EXT * ROW_INVENTORY_EXT)
#define INVENTORY_EXT3_SIZE		(INVENTORY_EXT2_SIZE + COLUMN_INVENTORY_EXT * ROW_INVENTORY_EXT)
#define INVENTORY_EXT4_SIZE		(INVENTORY_EXT3_SIZE + COLUMN_INVENTORY_EXT * ROW_INVENTORY_EXT)
//equipment index
...
#define MAX_MY_INVENTORY_INDEX			(MAX_EQUIPMENT_INDEX + INVENTORY_EXT4_SIZE)
