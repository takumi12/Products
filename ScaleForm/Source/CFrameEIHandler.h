...
class CFrameEIHandler : public CFxUIObj
{
public:
	CFrameEIHandler();
	virtual ~CFrameEIHandler();
	static bool Make(int _UIType, CFxUIManager*_GfxRepo, const char* Name, const char* _pfilename, CInternalmethod* pcommand, CExternalmethod* method, UPInt _memoryArena = 0, GFxMovieView::AlignType AlignType = GFxMovieView::Align_TopLeft, FontConfig* _pconfig = NULL,const char* _languag = NULL);
