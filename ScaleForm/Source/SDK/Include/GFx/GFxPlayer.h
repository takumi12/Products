...
class GFxLog;
class GFxValue;
//typedef void func_member_value(const char*);
typedef void func_member_value(void*, const char*, void*);
...
public:
    ...
    public:
                           ...
                           Double z, Double xrotation, Double yrotation, Double zscale)
        {
            ...
            YRotation = yrotation;
            ZScale = zscale;
            PerspFOV = (double) DEFAULT_FLASH_FOV;
#else
...
protected:
    ...
    public:
        ...
        bool    HashTableMember(void* pdata, func_member_value& funceTable, void* pClass, GFxValue* val, bool isdobj) const;
        ...
        bool    Invoke(void* pdata, GFxValue* presult, const char* name, const GFxValue* pargs, UPInt nargs, bool isdobj);
...
public:
    ...
    //
	bool        HashTable(func_member_value &funceTable, void* pClass, GFxValue* val) const 
	{
        GASSERT(IsObject());
        return pObjectInterface->HashTableMember(Value.pData, funceTable, pClass, val, IsDisplayObject());
	}
...
class GFxASUserData : public GRefCountBase<GFxASUserData, GStat_Default_Mem>
{
    ...
    GFxValue::ObjectInterface*  pLastObjectInterface;
    void*                       pLastData;
    bool                        IsLastDispObj;

public:
    GFxASUserData() : pLastObjectInterface(NULL), pLastData(NULL), IsLastDispObj(false) {}
    virtual ~GFxASUserData() {}

    // Sets the weak ref descriptor. Only used internally.
    void            SetLastObjectValue(GFxValue::ObjectInterface* pobjIfc, void* pdata, bool isdobj);
...
public:
    ...
    virtual void    CreateObject(GFxValue* pvalue, const char* className = NULL, const GFxValue* pargs = NULL, UInt nargs = 0)      = 0;
