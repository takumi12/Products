...
public:
    ...
    GFxResourceBinding(GMemoryHeap *pheap);
    ~GFxResourceBinding();
...
public:
    ...
    public:
        ...
        { GASSERT(hdata); ((GRefCountImpl*)hdata)->AddRef(); }
        virtual void    Release(DataHandle hdata)
        { GASSERT(hdata); ((GRefCountImpl*)hdata)->Release(); }
        ...
        virtual bool    CreateResource(DataHandle hdata, GFxResourceBindData *pbindData,
                                       GFxLoadStates *plp, GMemoryHeap *pheap) const = 0;
...
public:
    ...
    bool            CreateResource(GFxResourceBindData *pbindData, GFxLoadStates *plp,
                                   GMemoryHeap *pheap) const
    {        
