...
enum GFxTagType
{
    ...
    GFxTag_SoundStreamHead          = 18,
    GFxTag_SoundStreamBlock         = 19,
    ...
    GFxTag_DefineCompactedFont      = 1005,
    GFxTag_DefineExternalSound      = 1006,
    GFxTag_DefineExternalStreamSound = 1007,
    GFxTag_DefineSubImage           = 1008,
    GFxTag_DefineExternalImage2      = 1009,
