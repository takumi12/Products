...
#ifndef INC_GSplayTree_H
#define INC_GSplayTree_H
...
//
//------------------------------------------------------------------------
template<class T, class Accessor> class GSplayTree
{
...
//------------------------------------------------------------------------
template<class T, class Accessor> class GSplayTreeMulti
{
public:
