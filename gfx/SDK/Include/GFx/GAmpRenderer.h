...
public:
    ...
    virtual void DrawBlurRect(GTexture* psrcin, const GRectF& insrcrect, const GRectF& destrect, const GRenderer::BlurFilterParams& params, bool islast)
    {
	    ...
	    if (OverrideFilters)
	    {
	        ...
	        pBaseRenderer->DrawColorMatrixRect(psrcin, insrcrect, destrect, cmatrix, islast);
	    }
	    else
	        pBaseRenderer->DrawBlurRect(psrcin, insrcrect, destrect, params, islast);
    }
    ...
    virtual void DrawColorMatrixRect(GTexture* psrcin, const GRectF& insrcrect, const GRectF& destrect, const Float *matrix, bool islast)
    {
	    ...
	    if (OverrideFilters)
	    {
	        ...
	        pBaseRenderer->DrawColorMatrixRect(psrcin, insrcrect, destrect, matrix, islast);
    }
