...
// Image data, part of GFxAmpMemItem
struct GFxAmpMemItemExtra : public GRefCountBase<GFxAmpMemItemExtra, GStat_Default_Mem>
{
    UInt32                              ImageId;
    UInt32                              AtlasId;
    GRect<SInt32>                       AtlasRect;

    GFxAmpMemItemExtra(UInt32 imageId) : ImageId(imageId), AtlasId(0) { }
...
struct GFxAmpMemItem : public GRefCountBase<GFxAmpMemItem, GStat_Default_Mem>
{
    ...
    bool                                StartExpanded;
    UInt32                              ID;
    GPtr<GFxAmpMemItemExtra>            ImageData;
    GArrayLH< GPtr<GFxAmpMemItem> >     Children;

    GFxAmpMemItem(UInt32 id) : Value(0), HasValue(false), StartExpanded(false), ID(id)
    { }
    ...
    GFxAmpMemItem*              SearchForName(const char* name);
...
class FuncTreeItem : public GRefCountBase<FuncTreeItem, GStat_Default_Mem>
{
public:
    ...
    UInt32                          TreeItemId;
    GArrayLH< GPtr<FuncTreeItem> >  Children;

    void                GetAllFunctions(GHashSet<UInt64>* functionIds) const;
...
//
struct GFxAmpFunctionTreeStats : public GRefCountBase<GFxAmpFunctionTreeStats, GStat_Default_Mem>
{
    GStringLH                           ViewName;
    ...
    // operators
    void        Merge(const GFxAmpFunctionTreeStats& other);
...
struct GFxMovieStats : public GRefCountBase<GFxMovieStats, GStat_Default_Mem>
{
    ...
    GPtr<GFxAmpFunctionTreeStats> FunctionTreeStats;
...
// Image information
struct ImageInfo : public GRefCountBase<ImageInfo, GStat_Default_Mem>
{
    UInt32      Id;
    GStringLH   Name;
    GStringLH   HeapName;
...
public:
    ...
    GPtr<GFxAmpMovieFunctionStats>      DisplayStats;
    GPtr<GFxAmpFunctionTreeStats>       DisplayFunctionStats;
    ...
    GArrayLH< GPtr<ImageInfo> >         ImageList;
