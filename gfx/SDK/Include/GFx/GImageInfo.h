...
public:
    ...
    // Memory consumed by this image, to be reported by AMP
    virtual UPInt       GetBytes() const                    = 0;
    // Is this memory allocated outside GFx?
    ...
    virtual GImage*     GetImage() const                    = 0;
    virtual GImageBase::ImageFormat GetFormat() const { return GImageBase::Image_None; };
...
public:
    ...
    virtual GImageBase::ImageFormat GetFormat() const;
#endif
...
public:
    ...
    virtual bool        IsExternal() const                  { return pBaseImage->IsExternal(); }
    virtual UInt32      GetImageId() const                  { return ImageId; }
    virtual GImage*     GetImage() const                    { return pBaseImage->GetImage(); }
    virtual GImageBase::ImageFormat GetFormat() const       { return pBaseImage->GetFormat(); }
#endif
    ...
    virtual GImageInfoBase *GetBaseImage() const            { return pBaseImage; }
};
