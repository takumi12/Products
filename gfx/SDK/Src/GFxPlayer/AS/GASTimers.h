...
class GASIntervalTimer : public GNewOverrideBase<GFxStatMV_ActionScript_Mem>
{
    GASFunctionRef              Function;
    GASWeakPtr<GASObject>       Object;
...
private:
    static void Set(const GASFnCall& fn, bool timeout);
};
