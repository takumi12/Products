...
public:
    ...
    virtual void        Display(GFxDisplayContext &context, GFxCharacter* pinstanceInfo);
...
#ifndef GFC_NO_SOUND
    virtual GFxSoundStreamDef*  GetSoundStream() const                                  = 0;
    virtual void                SetSoundStream(GFxSoundStreamDef*)                      = 0;
...
public:
    ...
    virtual void                AddFrameName(const GString& name, GFxLog *plog)       = 0;
