...
// about the gradient. 
class GFxGradientData : public GRefCountBase<GFxGradientData, GFxStatMD_CharDefs_Mem>
{
    bool                LinearRGB;
    UByte               Type;
    UInt16              RecordCount;
...
public:
    ...
    GImage*             CreateGradientImage(GFxGradientParams *pparams,
...
class GFxFillStyle : public GNewOverrideBase<GFxStatMD_CharDefs_Mem> //public GFxBaseFillStyle
{
public:
    GFxFillStyle();
    ...
    GImageInfoBase* GetImageInfo(const GFxDisplayContext& dc) const;
...
private:
    ...
    bool            GetGradientFillTexture(GRenderer::FillTexture *ptexture,
                                            const GFxDisplayContext& dc,
                                            Float scaleMultiplier,
                                            const GRenderer::Matrix* s9gImgAdjust) const;
    bool            GetImageFillTexture(GRenderer::FillTexture *ptexture,
                                            const GFxDisplayContext& dc,
                                            Float scaleMultiplier,
                                            const GRenderer::Matrix* s9gImgAdjust) const;
};
...
public:
    ...
    bool            GetStrokeHinting() const{ return (StyleFlags & LineFlag_StrokeHinting) != 0;    }
