...
Filename    :   GHeapStaticTables.cpp
Content     :
            :
Created     :   March, 2009
...
//------------------------------------------------------------------------
const UInt32 GHeapBitSet1::HeadUsedTable[32] = 
{
...
//------------------------------------------------------------------------
const UInt32 GHeapBitSet1::TailUsedTable[32] = 
{
...
//------------------------------------------------------------------------
const UInt32 GHeapBitSet1::HeadFreeTable[32] = 
{
...
//------------------------------------------------------------------------
const UInt32 GHeapBitSet1::TailFreeTable[32] = 
{
...
//------------------------------------------------------------------------
const UByte GHeapBitSet1::LastFreeBlock[256] = 
{
    8,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,4,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,
    5,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,4,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,
    6,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,4,0,1,0,2,0,1,0,3,0,1,0,2,0,1,0,
...
//------------------------------------------------------------------------
const UByte GHeapBitSet1::LastUsedBlock[256] = 
{
