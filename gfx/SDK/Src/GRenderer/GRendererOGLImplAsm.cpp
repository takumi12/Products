...
static const char *p1PS_TextTextureColor = 
"!!ARBfp1.0\n"
"TEMP texr;\n"
"TEX    texr, fragment.texcoord[0], texture[0], 2D;\n"
...
static const char *p1PS_TextTextureColorMultiply = 
"!!ARBfp1.0\n"
"TEMP texr;\n"
"TEX    texr, fragment.texcoord[0], texture[0], 2D;\n"
...
static const char *p1PS_TextTextureYUV = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
"MUL  Y, Y.r, 1.164;\n"
"TEX  U, fragment.texcoord[0], texture[1], 2D;\n"
"SUB  U, U, 0.50196078431372549019;\n"
"TEX  V, fragment.texcoord[0], texture[2], 2D;\n"
"SUB  V, V, 0.50196078431372549019;\n"
"MAD  Y.rg, V.r, { 1.596, -0.813 }, Y;\n"
"MAD  Y.gb, U.r, { 0, -0.392, 2.017 }, Y;\n"
"MOV  Y.a, 1;\n"
"MAD  result.color, Y, fragment.texcoord[2], fragment.texcoord[3];\n"
"END\n";

static const char *p1PS_TextTextureYUVMultiply = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
"MAD  Y.gb, U.r, { 0, -0.392, 2.017 }, Y;\n"
"MOV  Y.a, 1;\n"
"MAD  Y, Y, fragment.texcoord[2], fragment.texcoord[3];\n"
"LRP  result.color, Y.a, Y, 1;\n"
"END\n";

static const char *p1PS_TextTextureYUVA = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
"TEX  V, fragment.texcoord[0], texture[2], 2D;\n"
"SUB  V, V, 0.50196078431372549019;\n"
"TEX  Y.a, fragment.texcoord[0], texture[3], 2D;\n"
"MAD  Y.rg, V.r, { 1.596, -0.813 }, Y;\n"
"MAD  Y.gb, U.r, { 0, -0.392, 2.017 }, Y;\n"
"MAD  result.color, Y, fragment.texcoord[2], fragment.texcoord[3];\n"
"END\n";

static const char *p1PS_TextTextureYUVAMultiply = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
"MOV    texr.rgb, fragment.color;\n"
"ADD    texr, texr, fragment.texcoord[3];\n"
"MOV    result.color.a, texr.a;\n"
"MUL    result.color.rgb, texr, texr.a;\n"
"END\n";

static const char *p1PS_AcTextTextureColor = 
"!!ARBfp1.0\n"
"TEMP texr;\n"
"TEX    texr, fragment.texcoord[0], texture[0], 2D;\n"
"MAD    texr, texr, fragment.color, fragment.texcoord[3];\n"
"MOV    result.color.a, texr.a;\n"
"MUL    result.color.rgb, texr, texr.a;\n"
"END\n";

static const char *p1PS_AcTextTextureColorMultiply = 
"!!ARBfp1.0\n"
"TEMP texr;\n"
"TEX    texr, fragment.texcoord[0], texture[0], 2D;\n"
"MAD    texr, texr, fragment.color, fragment.texcoord[3];\n"
...
static const char *p1PS_AcTextTextureYUV = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.07303529411764705881;\n"
"TEX  U, fragment.texcoord[0], texture[1], 2D;\n"
"SUB  U, U, 0.50196078431372549019;\n"
"TEX  V, fragment.texcoord[0], texture[2], 2D;\n"
"SUB  V, V, 0.50196078431372549019;\n"
...
static const char *p1PS_AcTextTextureYUVMultiply = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
"MAD  Y, Y, fragment.texcoord[2], fragment.texcoord[3];\n"
"LRP  Y, Y.a, Y, 1;\n"
"MOV  result.color.a, Y.a;\n"
"MUL  result.color.rgb, Y, Y.a;\n"
"END\n";

static const char *p1PS_AcTextTextureYUVA = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
static const char *p1PS_AcTextTextureYUVAMultiply = 
"!!ARBfp1.0\n"
"TEMP Y, U, V;\n"
"TEX  Y, fragment.texcoord[0], texture[0], 2D;\n"
"SUB  Y, Y.r, 0.062745098039215685;\n"
...
public:
    ...
    virtual bool                SetDependentVideoMode()
    {
        ...
        if (CheckExtension(glexts, "GL_ARB_vertex_program") && CheckExtension(glexts, "GL_ARB_fragment_program"))
        {
            ...
            InitFragShaderAsm(PS_TextTextureColor, p1PS_TextTextureColor);
            InitFragShaderAsm(PS_TextTextureColorMultiply, p1PS_TextTextureColorMultiply);
            InitFragShaderAsm(PS_TextTextureYUV, p1PS_TextTextureYUV);
            InitFragShaderAsm(PS_TextTextureYUVMultiply, p1PS_TextTextureYUVMultiply);
            InitFragShaderAsm(PS_TextTextureYUVA, p1PS_TextTextureYUVA);
            InitFragShaderAsm(PS_TextTextureYUVAMultiply, p1PS_TextTextureYUVAMultiply);
            ...
            InitFragShaderAsm(PS_AcTextTextureColor, p1PS_AcTextTextureColor);
            InitFragShaderAsm(PS_AcTextTextureColorMultiply, p1PS_AcTextTextureColorMultiply);
            InitFragShaderAsm(PS_AcTextTextureYUV, p1PS_AcTextTextureYUV);
            InitFragShaderAsm(PS_AcTextTextureYUVMultiply, p1PS_AcTextTextureYUVMultiply);
            InitFragShaderAsm(PS_AcTextTextureYUVA, p1PS_AcTextTextureYUVA);
            InitFragShaderAsm(PS_AcTextTextureYUVAMultiply, p1PS_AcTextTextureYUVAMultiply);
